...
class AdminOnGoingScreen2 extends StatefulWidget {
  @override
  _AdminOnGoingScreen2State createState() => _AdminOnGoingScreen2State();
}

class _AdminOnGoingScreen2State extends State<AdminOnGoingScreen2> {
